		...
		<div class="box">
			...
			<div class="box-body">
				...
				<form method="post">
                    ...
                    $columna = "id";
					$valor = $exp[3];
					$reaultado = MateriasC::VerNotas2C($columna, $valor);
                            echo'<h2>Fecha:</h2>
							<input type="date" class="input-lg" name="fecha" value="'.$reaultado["fecha"].'">
                            <input type="hidden" class="input-lg" name="nota_id" value="'.$reaultado["id"].'">

							<h2>Profesor:</h2>
							<input type="text" class="input-lg" name="profesor" required="" value="'.$reaultado["profesor"].'">

						</div>

						<div class="col-md-6 col-xs-12">
							
							<h2>Estado Actual:'.$reaultado["estado"].'</h2>
							<select class="input-lg" name="estado">
								
								<option value="'.$reaultado["estado"].'">Seleccionar...</option>
							...
							<h2>Nota Final:</h2>
							<input type="text" class="input-lg" name="nota_final" value="'.$reaultado["nota_final"].'">';
