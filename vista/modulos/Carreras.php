			...
			<div class="box-header">
				...
				<form method="post">
					...
					<div class="col-md-6 col-xs-12">
						...
						<input type="text" name="carrera" class="form-control" onKeyPress="return soloLetras(event)"  placeholder="Ingresar Nueva Especialidad" MinLength="4" MaxLength="30" required>
