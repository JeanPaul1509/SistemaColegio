	...
	<section class="content">
		...
		<div class="box">
			...
			<div class="box-header">
				...
				<button class="btn btn-primary btn-lg" data-toggle="modal" data-target="#CrearMateria">Crear Curso</button>
			...
			<form method="post" enctype="multipart/form-data">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control input-lg" name="grado" required="">
